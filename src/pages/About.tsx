            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-lg text-gray-600 mb-4">
                  Founded in 2010, KS TelecomServ has been at the forefront of the telecommunications industry, providing innovative solutions to businesses and individuals.
                </p>
                <p className="text-lg text-gray-600 mb-4">
